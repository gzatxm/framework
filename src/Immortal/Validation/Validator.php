...
use Immortal\Contracts\Validation\Validator as ValidatorContract;
...
class Validator implements ValidatorContract
{
     ...
     *
     * @var \Immortal\Validation\PresenceVerifierInterface
     */
     ...
     *
     * @var \Immortal\Support\MessageBag
     */
    protected $messages;
    ...
    {
        if ($extensions) {
            $keys = array_map('\Immortal\Support\Str::snake', array_keys($extensions));
    ...
    {
        if ($replacers) {
            $keys = array_map('\Immortal\Support\Str::snake', array_keys($replacers));
     ...
     *
     * @return \Immortal\Validation\PresenceVerifierInterface
     *
     ...
     *
     * @param  \Immortal\Validation\PresenceVerifierInterface  $presenceVerifier
     * @return void
     */
