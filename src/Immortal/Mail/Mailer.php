...
use Immortal\Contracts\View\Factory;
...
use Immortal\Contracts\Queue\Factory as QueueContract;
use Immortal\Contracts\Mail\Mailable as MailableContract;
use Immortal\Contracts\Mail\MailQueue as MailQueueContract;
...
class Mailer implements MailerContract, MailQueueContract
{
     ...
     *
     * @var \Immortal\Contracts\Events\Dispatcher|null
     */
    protected $events;
     ...
     *
     * @var \Immortal\Contracts\Queue\Queue
     */
    protected $queue;
     ...
     *
     * @param  \Immortal\Contracts\View\Factory  $views
     * @param  \Swift_Mailer  $swift
     * @param  \Immortal\Contracts\Events\Dispatcher|null  $events
     * @return void
     */
     ...
     *
     * @param  \Immortal\Mail\Message  $message
     * @param  string  $view
     * @param  string  $plain
     * @param  string  $raw
     * @param  array  $data
     ...
     *
     * @return \Immortal\Contracts\View\Factory
     */
     ...
     *
     * @param  \Immortal\Contracts\Queue\Queue  $queue
     * @return $this
     */
