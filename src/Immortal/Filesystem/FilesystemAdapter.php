...
namespace Immortal\Filesystem;

use RuntimeException;
use Immortal\Http\File;
...
use Immortal\Contracts\Filesystem\Cloud as CloudFilesystemContract;
use Immortal\Contracts\Filesystem\Filesystem as FilesystemContract;
use Immortal\Contracts\Filesystem\FileNotFoundException as ContractFileNotFoundException;
...
class FilesystemAdapter implements FilesystemContract, CloudFilesystemContract
{
     ...
     * @return string
     *
     * @throws \Immortal\Contracts\Filesystem\FileNotFoundException
     */
     ...
     *
     * @param  string  $path
     * @param  \Immortal\Http\UploadedFile  $file
     * @param  string  $visibility
     * @return string|false
     */
     ...
     *
     * @param  string  $path
     * @param  \Immortal\Http\File|\Immortal\Http\UploadedFile  $file
     * @param  string  $name
     * @param  string  $visibility
     * @return string|false
     */
