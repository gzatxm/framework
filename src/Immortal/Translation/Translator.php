...
namespace Immortal\Translation;
...
use Immortal\Support\NamespacedItemResolver;
...
class Translator extends NamespacedItemResolver implements TranslatorInterface
{
     ...
     *
     * @var \Immortal\Translation\LoaderInterface
     */
    protected $loader;
     ...
     *
     * @param  \Immortal\Translation\LoaderInterface  $loader
     * @param  string  $locale
     * @return void
     */
     ...
     *
     * @return \Immortal\Translation\LoaderInterface
     */
