...
use Immortal\Contracts\Cache\Repository as CacheContract;
...
class Worker
{
     ...
     *
     * @var \Immortal\Queue\QueueManager
     */
    protected $manager;
     ...
     *
     * @var \Immortal\Contracts\Cache\Repository
     */
    protected $cache;
     ...
     *
     * @var \Immortal\Foundation\Exceptions\Handler
     */
     ...
     * @param  \Immortal\Contracts\Debug\ExceptionHandler  $exceptions
     * @return void
     */
     ...
     * @param  string  $queue
     * @param  \Immortal\Queue\WorkerOptions  $options
     * @return void
     */
    ...
    protected function daemonShouldRun(WorkerOptions $options)
    {
        if (($this->manager->isDownForMaintenance() && ! $options->force) ||
            $this->events->until('immortal.queue.looping') === false) {
     ...
     *
     * @param  \Immortal\Contracts\Queue\Queue  $connection
     * @param  string  $queue
    ...
    {
        if ($this->cache) {
            return $this->cache->get('immortal:queue:restart');
        }
    }
     ...
     *
     * @param  \Immortal\Contracts\Cache\Repository  $cache
     * @return void
     */
     ...
     *
     * @return \Immortal\Queue\QueueManager
     */
