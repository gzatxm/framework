...
use Immortal\Contracts\Queue\Factory as FactoryContract;
use Immortal\Contracts\Queue\Monitor as MonitorContract;
...
class QueueManager implements FactoryContract, MonitorContract
{
    ...
    {
        $this->app['events']->listen('immortal.queue.looping', $callback);
    }
     ...
     *
     * @param  string  $driver
     * @return \Immortal\Queue\Connectors\ConnectorInterface
     *
