...
use Immortal\Queue\Console\WorkCommand;
use Immortal\Queue\Console\ListenCommand;
use Immortal\Queue\Console\RestartCommand;
use Immortal\Queue\Connectors\SqsConnector;
use Immortal\Queue\Connectors\NullConnector;
use Immortal\Queue\Connectors\SyncConnector;
use Immortal\Queue\Connectors\RedisConnector;
use Immortal\Queue\Connectors\DatabaseConnector;
use Immortal\Queue\Failed\NullFailedJobProvider;
use Immortal\Queue\Connectors\BeanstalkdConnector;
use Immortal\Queue\Failed\DatabaseFailedJobProvider;
...
class QueueServiceProvider extends ServiceProvider
{
    ...
    protected function registerWorker()
    {
        ...
        $this->app->singleton('queue.worker', function ($app) {
            return new Worker(
                ...
                $app['Immortal\Contracts\Debug\ExceptionHandler']
            );
        });
    }
     ...
     *
     * @param  \Immortal\Queue\QueueManager  $manager
     * @return void
     */
