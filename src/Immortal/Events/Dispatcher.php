...
class Dispatcher implements DispatcherContract
{
     ...
     *
     * @param  \Immortal\Contracts\Broadcasting\ShouldBroadcast  $event
     * @return void
     */
    ...
    protected function handlerShouldBeQueued($class)
    {
        try {
            return (new ReflectionClass($class))->implementsInterface(
                'Immortal\Contracts\Queue\ShouldQueue'
            );
        } catch (Exception $e) {
            return false;
        }
    ...
    protected function createQueuedHandlerCallable($class, $method)
    {
        return function () use ($class, $method) {
            ...
            if (method_exists($class, 'queue')) {
                ...
                $this->resolveQueue()->push('Immortal\Events\CallQueuedHandler@call', [
    ...
    protected function callQueueMethodOnHandler($class, $method, $arguments)
    {
        ...
        $handler->queue($this->resolveQueue(), 'Immortal\Events\CallQueuedHandler@call', [
            'class' => $class, 'method' => $method, 'data' => serialize($arguments),
        ]);
    }
