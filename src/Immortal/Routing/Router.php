...
use Immortal\Contracts\Routing\Registrar as RegistrarContract;
...
class Router implements RegistrarContract
{
    ...
    {
        if ($this->container && $this->container->bound('Immortal\Routing\ResourceRegistrar')) {
            $registrar = $this->container->make('Immortal\Routing\ResourceRegistrar');
        } else {
     ...
     *
     * @param  \Immortal\Support\Collection  $middlewares
     * @return array
     */
    ...
    protected function findRoute($request)
    {
        ...
        $this->container->instance('Immortal\Routing\Route', $route);
