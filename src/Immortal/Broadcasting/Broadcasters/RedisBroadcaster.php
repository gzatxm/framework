...
namespace Immortal\Broadcasting\Broadcasters;

use Immortal\Support\Arr;
use Immortal\Support\Str;
use Immortal\Contracts\Redis\Database as RedisDatabase;
...
class RedisBroadcaster extends Broadcaster
{
     ...
     * The Redis instance.
     *
     * @var \Immortal\Contracts\Redis\Database
     */
    protected $redis;
     ...
     *
     * @param  \Immortal\Contracts\Redis\Database  $redis
