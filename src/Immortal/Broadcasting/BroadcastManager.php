...
use Immortal\Broadcasting\Broadcasters\LogBroadcaster;
use Immortal\Broadcasting\Broadcasters\NullBroadcaster;
use Immortal\Contracts\Broadcasting\ShouldBroadcastNow;
use Immortal\Broadcasting\Broadcasters\RedisBroadcaster;
use Immortal\Broadcasting\Broadcasters\PusherBroadcaster;
use Immortal\Contracts\Broadcasting\Factory as FactoryContract;
...
class BroadcastManager implements FactoryContract
{
     ...
     *
     * @param  string  $name
     * @return \Immortal\Contracts\Broadcasting\Broadcaster
     */
