...
namespace Immortal\Database\Schema\Grammars;

use RuntimeException;
use Doctrine\DBAL\Types\Type;
use Immortal\Support\Fluent;
use Doctrine\DBAL\Schema\Table;
use Doctrine\DBAL\Schema\Column;
use Doctrine\DBAL\Schema\TableDiff;
use Immortal\Database\Connection;
use Doctrine\DBAL\Schema\Comparator;
use Immortal\Database\Query\Expression;
use Immortal\Database\Schema\Blueprint;
use Immortal\Database\Grammar as BaseGrammar;
...
abstract class Grammar extends BaseGrammar
{
     ...
     *
     * @param  \Immortal\Database\Schema\Blueprint  $blueprint
     * @param  \Immortal\Support\Fluent  $command
     ...
     * @param  string  $sql
     * @param  \Immortal\Database\Schema\Blueprint  $blueprint
     * @param  \Immortal\Support\Fluent  $column
     * @return string
     */
     ...
     * @param  \Immortal\Database\Schema\Blueprint  $blueprint
     * @param  string  $name
     * @return \Immortal\Support\Fluent|null
     */
    ...
    protected function getTableWithColumnChanges(Blueprint $blueprint, Table $table)
    {
        ...
        foreach ($blueprint->getChangedColumns() as $fluent) {
            ...
            // Doctrine column definitions - which is necessary because Zgutu and Doctrine
     ...
     *
     * @param  \Doctrine\DBAL\Schema\Table  $table
     * @param  \Immortal\Support\Fluent  $fluent
