...
use Immortal\Contracts\Routing\UrlRoutable;
use Immortal\Contracts\Queue\QueueableEntity;
use Immortal\Database\Eloquent\Relations\Pivot;
use Immortal\Database\Eloquent\Relations\HasOne;
use Immortal\Database\Eloquent\Relations\HasMany;
use Immortal\Database\Eloquent\Relations\MorphTo;
use Immortal\Database\Eloquent\Relations\MorphOne;
use Immortal\Database\Eloquent\Relations\Relation;
use Immortal\Support\Collection as BaseCollection;
use Immortal\Database\Eloquent\Relations\BelongsTo;
use Immortal\Database\Eloquent\Relations\MorphMany;
use Immortal\Database\Query\Builder as QueryBuilder;
use Immortal\Database\Eloquent\Relations\MorphToMany;
use Immortal\Database\Eloquent\Relations\BelongsToMany;
use Immortal\Database\Eloquent\Relations\HasManyThrough;
use Immortal\Database\ConnectionResolverInterface as Resolver;
...
abstract class Model implements ArrayAccess, Arrayable, Jsonable, JsonSerializable, QueueableEntity, UrlRoutable
{
     ...
     *
     * @param  \Immortal\Database\Eloquent\Scope|\Closure|string  $scope
     ...
     *
     * @param  \Immortal\Database\Eloquent\Scope|string  $scope
     * @return bool
     */
     ...
     *
     * @param  \Immortal\Database\Eloquent\Scope|string  $scope
     * @return \Immortal\Database\Eloquent\Scope|\Closure|null
     */
     ...
     * @return $this
     *
     * @throws \Immortal\Database\Eloquent\MassAssignmentException
     */
     ...
     * @return \Immortal\Database\Eloquent\Collection|static[]
     */
     ...
     *
     * @param  array|string  $relations
     * @return \Immortal\Database\Eloquent\Builder|static
     */
     ...
     * @return \Immortal\Database\Eloquent\Relations\HasOne
     */
     ...
     * @param  string  $id
     * @param  string  $localKey
     * @return \Immortal\Database\Eloquent\Relations\MorphOne
     */
     ...
     * @return \Immortal\Database\Eloquent\Relations\BelongsTo
     */
     ...
     * @param  string  $type
     * @param  string  $id
     * @return \Immortal\Database\Eloquent\Relations\MorphTo
     */
     ...
     * @param  string  $foreignKey
     * @param  string  $localKey
     * @return \Immortal\Database\Eloquent\Relations\HasMany
     */
     ...
     * @return \Immortal\Database\Eloquent\Relations\HasManyThrough
     */
     ...
     * @param  string  $id
     * @param  string  $localKey
     * @return \Immortal\Database\Eloquent\Relations\MorphMany
     */
     ...
     * @param  string  $otherKey
     * @param  string  $relation
     * @return \Immortal\Database\Eloquent\Relations\BelongsToMany
     */
     ...
     * @param  string  $otherKey
     * @param  bool  $inverse
     * @return \Immortal\Database\Eloquent\Relations\MorphToMany
     */
    ...
    protected function getRelationshipFromMethod($method)
    {
        ...
        if (! $relations instanceof Relation) {
            throw new LogicException('Relationship method must return an object of type '
                .'Immortal\Database\Eloquent\Relations\Relation');
        }
     ...
     * @return \Immortal\Database\Eloquent\Model
     */
     ...
     *
     * @return \Immortal\Database\Connection
     */
     ...
     *
     * @return \Immortal\Database\ConnectionResolverInterface
     */
     ...
     *
     * @param  \Immortal\Database\ConnectionResolverInterface  $resolver
     * @return void
     */
     ...
     *
     * @return \Immortal\Contracts\Events\Dispatcher
     */
     ...
     *
     * @param  \Immortal\Contracts\Events\Dispatcher  $dispatcher
     * @return void
     */
