...
use Immortal\Pagination\Paginator;
use Immortal\Database\Query\Expression;
use Immortal\Pagination\LengthAwarePaginator;
use Immortal\Database\Eloquent\Relations\Relation;
use Immortal\Database\Query\Builder as QueryBuilder;

/**
 * @mixin \Immortal\Database\Query\Builder
 */
class Builder
{
    /**
     ...
     *
     * @var \Immortal\Database\Query\Builder
     */
    protected $query;
     ...
     *
     * @var \Immortal\Database\Eloquent\Model
     */
    protected $model;
     ...
     * @param  \Immortal\Database\Eloquent\Scope|\Closure  $scope
     * @return $this
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \Immortal\Database\Eloquent\Model|\Immortal\Database\Eloquent\Collection|static[]|static|null
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \Immortal\Database\Eloquent\Model|\Immortal\Database\Eloquent\Collection
     *
     * @throws \Immortal\Database\Eloquent\ModelNotFoundException
     */
     ...
     *
     * @param  array  $columns
     * @return \Immortal\Database\Eloquent\Model|static|null
     */
     ...
     *
     * @param  array  $columns
     * @return \Immortal\Database\Eloquent\Model|static
     *
     * @throws \Immortal\Database\Eloquent\ModelNotFoundException
     */
     ...
     * @param  int|null  $page
     * @return \Immortal\Contracts\Pagination\LengthAwarePaginator
     *
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \Immortal\Contracts\Pagination\Paginator
     */
     ...
     *
     * @param  string  $name
     * @return \Immortal\Database\Eloquent\Relations\Relation
     */
     ...
     *
     * @param  \Immortal\Database\Eloquent\Builder  $hasQuery
     * @param  \Immortal\Database\Eloquent\Relations\Relation  $relation
     * @param  string  $operator
     * @param  int  $count
     * @param  string  $boolean
     * @return \Immortal\Database\Eloquent\Builder|static
     ...
     *
     * @param  \Immortal\Database\Eloquent\Builder  $relation
     * @return \Immortal\Database\Eloquent\Builder|static
     */
