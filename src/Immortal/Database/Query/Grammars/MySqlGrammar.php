...
namespace Immortal\Database\Query\Grammars;

use Immortal\Support\Str;
use Immortal\Database\Query\Builder;
use Immortal\Database\Query\JsonExpression;
...
class MySqlGrammar extends Grammar
{
     ...
     *
     * @param  string  $key
     * @param  \Immortal\Database\Query\JsonExpression  $value
     * @return string
     */
