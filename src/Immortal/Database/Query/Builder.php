...
namespace Immortal\Database\Query;
...
use Immortal\Database\Query\Grammars\Grammar;
use Immortal\Pagination\LengthAwarePaginator;
use Immortal\Database\Query\Processors\Processor;
...
class Builder
{
     ...
     *
     * @var \Immortal\Database\Query\Grammars\Grammar
     */
    protected $grammar;
     ...
     *
     * @var \Immortal\Database\Query\Processors\Processor
     */
    protected $processor;
     ...
     *
     * @param  \Immortal\Database\ConnectionInterface  $connection
     * @param  \Immortal\Database\Query\Grammars\Grammar  $grammar
     * @param  \Immortal\Database\Query\Processors\Processor  $processor
     * @return void
     */
     ...
     * @return \Immortal\Database\Query\Builder|static
     */
     ...
     *
     * @param  \Closure|\Immortal\Database\Query\Builder|string $query
     * @param  string  $as
     * @return \Immortal\Database\Query\Builder|static
     *
     ...
     *
     * @param  \Immortal\Database\Query\Builder|static $query
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  \Immortal\Database\Query\Builder|\Closure  $query
     * @param  bool  $all
     * @return \Immortal\Database\Query\Builder|static
     */
     ...
     *
     * @param  mixed  $value
     * @return \Immortal\Database\Query\Expression
     */
     ...
     *
     * @return \Immortal\Database\ConnectionInterface
     */
     ...
     *
     * @return \Immortal\Database\Query\Processors\Processor
     */
     ...
     *
     * @return \Immortal\Database\Query\Grammars\Grammar
     */
