...
use Immortal\Database\Migrations\Migrator;
use Immortal\Database\Migrations\MigrationCreator;
use Immortal\Database\Console\Migrations\ResetCommand;
use Immortal\Database\Console\Migrations\StatusCommand;
use Immortal\Database\Console\Migrations\InstallCommand;
use Immortal\Database\Console\Migrations\MigrateCommand;
use Immortal\Database\Console\Migrations\RefreshCommand;
use Immortal\Database\Console\Migrations\RollbackCommand;
use Immortal\Database\Console\Migrations\MigrateMakeCommand;
use Immortal\Database\Migrations\DatabaseMigrationRepository;
