...
namespace Immortal\Database\Connectors;

use PDOException;
use Immortal\Support\Arr;
use InvalidArgumentException;
use Immortal\Database\MySqlConnection;
use Immortal\Database\SQLiteConnection;
use Immortal\Database\PostgresConnection;
use Immortal\Database\SqlServerConnection;
...
class ConnectionFactory
{
     ...
     *
     * @param  array  $config
     * @return \Immortal\Database\Connectors\ConnectorInterface
     *
