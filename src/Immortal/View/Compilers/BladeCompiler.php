...
namespace Immortal\View\Compilers;
...
class BladeCompiler extends Compiler implements CompilerInterface
{
    ...
    {
        return "<?php if (app('Immortal\\Contracts\\Auth\\Access\\Gate')->check{$expression}): ?>";
    }
    ...
    {
        return "<?php elseif (app('Immortal\\Contracts\\Auth\\Access\\Gate')->check{$expression}): ?>";
    }
    ...
    {
        return "<?php if (app('Immortal\\Contracts\\Auth\\Access\\Gate')->denies{$expression}): ?>";
    }
    ...
    {
        return "<?php elseif (app('Immortal\\Contracts\\Auth\\Access\\Gate')->denies{$expression}): ?>";
    }
